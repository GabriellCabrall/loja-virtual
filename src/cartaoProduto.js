...
export function renderizarCatalogo() {
    for (const produtoCatalogo of catalogo) {
        ...
        <img src="./assets/img/${produtoCatalogo.imagem}" alt="Produto ${produtoCatalogo.nome}" class="group-hover:scale-110 duration-300 my-3 rounded-lg">
    ...
    for (const produtoCatalogo of catalogo) {
        document.getElementById(`adicionar-${produtoCatalogo.id}`).addEventListener('click', () => adcionarAoCarrinho(produtoCatalogo.id))
    }
}
